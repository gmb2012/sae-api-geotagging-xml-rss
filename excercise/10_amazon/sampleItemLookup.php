...
defined('AWS_API_KEY') or define('AWS_API_KEY', 'AKIAIDZSGYFVWWBB7XVA');
defined('AWS_API_SECRET_KEY') or define('AWS_API_SECRET_KEY', '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');
defined('AWS_ASSOCIATE_TAG') or define('AWS_ASSOCIATE_TAG', 'wwwzapadlode-21');
